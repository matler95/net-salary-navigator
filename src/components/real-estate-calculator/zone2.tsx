  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid lg:grid-cols-2 gap-6 items-stretch">
        ...
        <section
          data-section="1"
          className="bg-card rounded-3xl p-6 border border-border shadow-sm flex flex-col h-full lg:order-1 transition-all duration-300"
        >
          <div className="flex items-center gap-3 border-b border-border/50 pb-4 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1 font-medium">
                Gotówka na start:{" "}
                <span className="text-foreground">{formatPLN(r.totalUpfront)}</span>
              </p>
            </div>
          </div>
                ...
                feedback={
                  <>
                    <span className="text-muted-foreground">
                      {formatPLN((s.purchasePrice * s.downPaymentPct) / 100)}
                    </span>
                  </>
                }
              />
                ...
                <div className="flex flex-col gap-2">
                  <div className="grid grid-cols-3 gap-2">
                    <button
                      ...
                      className={cn(
                        "text-xs py-2 rounded-lg border font-bold transition-all",
                        s.marketType === "wtórny"
                    ...
                    <button
                      ...
                      className={cn(
                        "text-xs py-2 rounded-lg border font-bold transition-all w-full text-center flex items-center justify-center gap-2",
                        s.hasAgency
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          s.hasAgency ? "bg-accent border-accent" : "border-muted-foreground",
                        )}
                      />
                      Kupuję z agencją (+2%)
                    </button>
                  ...
                  <p className="text-[10px] text-muted-foreground text-right mt-1">
                    Koszty transakcyjne łącznie:{" "}
                    <span className="font-bold text-foreground">{formatPLN(r.closingCosts)}</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <section
          data-section="2"
          className="bg-card rounded-3xl p-6 border border-border shadow-sm flex flex-col h-full lg:order-3 transition-all duration-300"
        >
          <div className="flex items-center gap-3 border-b border-border/50 pb-4 mb-4">
            <div className="w-10 h-10 rounded-xl bg-accent/10 text-accent flex items-center justify-center shrink-0">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-1 font-medium flex justify-between">
                ...
                <span>
                  Odsetki łącznie:{" "}
                  <span className="text-destructive">{formatPLN(r.totalInterestPaid)}</span>
                </span>
              </p>
            </div>
          </div>
            ...
            <div className="space-y-4 flex-1 animate-in fade-in slide-in-from-top-2 duration-300">
              <div className="grid grid-cols-2 gap-2 p-1 bg-muted/30 rounded-xl">
                <button
                  ...
                  className={cn(
                    "text-[11px] py-2 px-3 rounded-lg transition-all flex flex-col items-center gap-1",
        ...
        <section
          data-section="3"
          className="bg-card rounded-3xl p-6 border border-border shadow-sm flex flex-col h-full lg:order-2 transition-all duration-300"
        >
          <div className="flex items-center gap-3 border-b border-border/50 pb-4 mb-4">
            <div className="w-10 h-10 rounded-xl bg-accent/10 text-accent flex items-center justify-center shrink-0">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-1 font-medium flex justify-between flex-wrap gap-x-2">
                <span>
                  Zysk co miesiąc:{" "}
                  <span className={cn(steadyCashflow >= 0 ? "text-success" : "text-destructive")}>
                    {formatPLN2(steadyCashflow)}
                  </span>
                </span>
                {vacancyMonths > 0 && (
                  <span className="text-[10px] opacity-70">
                    ...
                    <span
                      className={cn(
                        r.monthlyCashflow >= 0 ? "text-success" : "text-warning-foreground",
                      )}
                    >
              ...
              <div className="pt-2">
                  ...
                  <div className="grid gap-2 sm:grid-cols-2">
                    ...
                    >
                      <div
                        className={cn(
                          "w-3 h-3 rounded-sm border",
                          s.tenantPaysAdmin ? "bg-accent border-accent" : "border-muted-foreground",
                        )}
                      />
                    ...
                    >
                      <div
                        className={cn(
                          "w-3 h-3 rounded-sm border",
                          s.tenantPaysMedia ? "bg-accent border-accent" : "border-muted-foreground",
                        )}
                      />
                      Najemca płaci media
                    </button>
                ...
                <div className="space-y-2 bg-muted/20 p-3 rounded-xl border border-border/50">
                  {[
                    ...
                    const pct =
                      ownerMonthlyCosts > 0 && cost.included ? (val / ownerMonthlyCosts) * 100 : 0;
                    return (
                      <div
                        key={cost.key}
                        className={cn(
                          "flex items-center gap-2 text-xs group",
                          !cost.included && "opacity-60",
                        )}
                      >
                        ...
                        <input
                          ...
                          value={val || ""}
                          onChange={(e) =>
                            setCosts((prev) => ({ ...prev, [cost.key]: Number(e.target.value) }))
                          }
                  ...
                  <div className="flex flex-col gap-1 pt-2 mt-1 border-t border-border/50">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                      Uwzględnia tylko koszty ponoszone przez właściciela.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section
          data-section="4"
          className="bg-card rounded-3xl p-6 border border-border shadow-sm flex flex-col h-full lg:order-4 transition-all duration-300"
        >
          <div className="flex items-center gap-3 border-b border-border/50 pb-4 mb-4">
            <div className="w-10 h-10 rounded-xl bg-accent/10 text-accent flex items-center justify-center shrink-0">
              ...
              <div className="flex items-center justify-between gap-4 rounded-2xl border border-border/50 bg-muted/50 p-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Jeśli włączone, kalkulacja uwzględnia zysk ze sprzedaży po zakończeniu
                    analizowanego okresu.
                  </p>
                </div>
                <Switch
                  checked={s.sellAtEnd}
                  onCheckedChange={(value) => updateS({ sellAtEnd: value })}
                />
              </div>
            </div>
          )}
